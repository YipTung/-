...
<div id="top">
	<h1>投票管理</h1><br/>
	<h5>欢迎您 <?php echo $_SESSION['user']; ?>，欢迎您浏览本留言板，您可以在本页面管理投票活动。<a style='color:red' href="add_vote.php">[发起新投票]</a></h5><br/>
</div>
<div id="container">
	<div id="navi">
	<ul>
	...
	<div id="info">
		<table>
			<tr><th align=center>序号</th><th align=center>投票主题</th><th align=center>发起人</th><th align=center>投票截止时间</th><th align=center>参与人数</th><th></th><th align=center>投票管理</th></tr>
			<?php 
				...
				$sql = "select * from lyb_vote_main where state =1 order by end_time desc limit ".($current_page-1)*$each_disNums.",".$each_disNums;
				$result = mysqli_query($link,$sql);
				$num = 1;
				while ($row=mysqli_fetch_assoc($result)) {
					...
					echo "<td align=center><a href='../send_sx.php'>".$row['originater']."</a></td>";
